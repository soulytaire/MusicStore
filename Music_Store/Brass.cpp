...
// brassTypes = { "saxophone", "trumpet", "flute", "recorder" };
...
{
	// check if the range type is valid
...
{
	return "BRS" + instrumentType.substr(0, 3) + rangeType.substr(0, 3) + brand.substr(0, 3) + model.substr(0, 3);
}
